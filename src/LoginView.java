...
public class LoginView extends javax.swing.JFrame {
   ...
   private void Login()
   {
        ...
        if (!auth.Check(jTextField1.getText(), jPasswordField1.getText()))
        {
            MW.errorBox("Неверный логин или пароль", "Авторизация");
            return;
        }
        this.setVisible(false); 
        JFrame  MainV; 
        MainV  = new	MainViewWin  ();
        MainV.show(); 
        UserM.uid= auth.uid;
       UserM .saveLog(0,"","Вход в систему");
   }
